(function() {
  ...
  function buildBanner() {
    ...
    banner.innerHTML = [
      ...
      '    <p id="ng-cookie-title" class="ng-cookie-title">COOKIE</p>',
      '    <p id="ng-cookie-desc" class="ng-cookie-desc">',
      '      Questo sito utilizza cookie tecnici necessari al funzionamento. Previo consenso, utilizza inoltre cookie di analisi statistica. Per dettagli e revoca del consenso consulta la <a href="/cookie.html">Cookie Policy</a>.',
      '    </p>',
      '  </div>',
      '  <div class="ng-cookie-actions">',
      '    <button type="button" class="ng-cookie-btn ng-cookie-btn-secondary" id="ng-cookie-reject">RIFIUTA</button>',
      '    <button type="button" class="ng-cookie-btn ng-cookie-btn-primary" id="ng-cookie-accept">ACCETTA</button>',
      '  </div>',
      '</div>'
    ].join('');
    return banner;
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  background:#0c0c0c;color:#f4f1e8;',
      '  border-top:3px solid #cc1429;',
      ...
      '  font-size:18px;letter-spacing:.06em;margin:0 0 6px 0;color:#f4f1e8;',
      '}',
      '.ng-cookie-desc{',
      '  font-size:14px;line-height:1.5;margin:0;color:#e8e1d0;',
      '}',
      '.ng-cookie-desc a{color:#f4f1e8;text-decoration:underline;}',
      ...
      '.ng-cookie-btn-primary{background:#cc1429;color:#fff;}',
      '.ng-cookie-btn-secondary{background:transparent;color:#f4f1e8;border:2px solid #f4f1e8;}',
